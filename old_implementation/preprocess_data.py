...
cityscapes_dir = data_dir + "cityscapes_data/"

train_imgs_dir = cityscapes_dir + "images/leftImg8bit/train/"
train_gt_dir = cityscapes_dir + "masks/gtFine/train/"

val_imgs_dir = cityscapes_dir + "images/leftImg8bit/val/"
val_gt_dir = cityscapes_dir + "masks/gtFine/val/"

# train_dirs = os.listdir(train_imgs_dir)
# val_dirs = os.listdir(val_imgs_dir)
