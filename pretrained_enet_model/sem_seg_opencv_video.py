# USAGE
# python sem_seg_opencv_video.py --model enet/enet-model.net --classes enet/enet-classes.txt --colors enet/enet-colors.txt --video videos/jakarta.mp4 --output output/jakarta.avi
